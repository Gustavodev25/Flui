  ...
  return (
    <header className="h-[56px] flex items-center justify-between px-4 sm:px-6 sticky top-0 z-40 bg-[#f7f7f5]">
      ...
      <div className="flex items-center gap-3 flex-1 lg:flex-none">
        ...
        <nav className="flex items-center gap-0.5 text-[13px] font-medium tracking-tight overflow-hidden">
          {!isCalendarPage && (
            <>
              <Link 
                to="/dashboard" 
                className="px-2.5 py-1.5 text-[#37352f]/45 hover:text-[#37352f] hover:bg-[#37352f]/5 rounded-xl transition-all duration-300 flex items-center shrink-0"
              >
                Início
              </Link>
              <div className="w-5 h-5 flex items-center justify-center shrink-0">
                <ChevronRight size={12} strokeWidth={3} className="text-[#37352f]/15" />
              </div>
            </>
          )}
          <div className="px-2.5 py-1.5 text-[#37352f] font-bold select-none truncate">
            <motion.span
