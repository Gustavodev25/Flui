...
const AIChatAssistant: React.FC = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: 'assistant', content: 'Oi! Me manda o que quer organizar.' }
  ])
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      setMessages(prev => [...prev, {
        role: 'assistant',
        content: 'Tive um problema aqui. Tenta de novo em instantes.'
      }])
    } finally {
      setIsLoading(false)
    }
            ...
            <div className="p-5 border-b border-[#f1f1f0] flex items-center justify-between bg-white/80 backdrop-blur-md sticky top-0 z-10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  {!isMinimized && <p className="text-[10px] text-[#25D366] font-bold tracking-widest">OpenRouter ativo</p>}
                </div>
              </div>
              ...
              <>
                    ...
                    <div className="flex justify-start">
                      <div className="bg-white border border-[#e9e9e7] p-4 rounded-2xl flex items-center gap-2">
                        ...
                        <span className="text-xs font-medium text-[#37352f]/40 italic">
                          {isFetchingReminder ? 'Checando lembretes...' : 'Organizando...'}
                        </span>
                      </div>
                    </div>
                  )}
                ...
                <div className="p-4 bg-white border-t border-[#f1f1f0]">
                  <div className="relative group">
                    <input
                      type="text"
                      placeholder="Digite sua tarefa ou pergunta..."
                      value={input}
